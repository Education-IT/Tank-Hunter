...
namespace Menu {
    ...
    void gameWin() {
        ...
        //std::cout << R"(    ▓▓▓▓▓▓▓▓▓▓▓▓          ▓▓▓▓▓▓          ██▒▒██▓▓▓▓▓▓)" << '\n';
        //std::cout << R"(    ▓▓▓▓██▒▒▓▓▓▓▓▓        ▓▓▓▓▓▓        ▓▓▓▓▓▓▒▒▓▓▓▓▓▓)" << '\n';
        //std::cout << R"(    ▓▓▓▓▓▓  ██▓▓▓▓        ▓▓▓▓▓▓        ▓▓▓▓██  ▓▓▓▓▓▓)"; color(white); std::cout << R"(                                    _          __)" << '\n'; color(8);
        //std::cout << R"(    ▓▓▓▓▓▓  ▓▓▓▓██        ▓▓▓▓▓▓        ▓▓▓▓██  ▓▓▓▓▓▓)"; color(white); std::cout << R"(     __  ______  __  __   _      __(_)___     / /)" << '\n'; color(8);
        //std::cout << R"(    ▒▒▓▓▓▓    ▓▓▓▓        ▓▓▓▓▒▒        ▓▓▓▓    ▓▓▓▓▓▓)"; color(white); std::cout << R"(    / / / / __ \/ / / /  | | /| / / / __ \   / /)" << '\n'; color(8);
        //std::cout << R"(    ██▓▓▓▓    ▓▓▓▓██      ▓▓▓▓██      ██▓▓▓▓    ▓▓▓▓▓▓)"; color(white); std::cout << R"(   / /_/ / /_/ / /_/ /   | |/ |/ / / / / /  /_/)" << '\n'; color(8);
        //std::cout << R"(    ▓▓▓▓▓▓    ▓▓▓▓▓▓      ▓▓▓▓▓▓      ▓▓▒▒▓▓    ▓▓▓▓▒▒)"; color(white); std::cout << R"(   \__, /\____/\__,_/    |__/|__/_/_/ /_/  (_))" << '\n'; color(8);
        //std::cout << R"(    ▓▓▓▓▓▓    ▒▒▓▓▓▓      ▓▓▓▓▓▓      ▓▓▓▓▓▓    ▓▓▓▓▓▓)"; color(white); std::cout << R"(  /____/)" << '\n'; color(8);
        //std::cout << R"(    ▓▓▓▓▓▓    ▓▓▓▓▓▓      ▓▓▓▓▓▓      ▓▓▓▓▓▓    ▓▓▓▓▓▓)"; color(white); std::cout << R"(     ________                    ______         )";  color(blue); std::cout << R"(__  ____              _)" << '\n'; color(8);
        //std::cout << R"(    ██▒▒▓▓    ▓▓▓▓▓▓      ▓▓▒▒▓▓      ▓▓▓▓▓▓    ▓▓▓▓▓▓)"; color(white); std::cout << R"(    / ____/ /___  _______  __   /_  __/___     )"; color(blue); std::cout << R"(/ / / / /___________ _(_)___  ___)" << '\n'; color(8);
        //std::cout << R"(    ▓▓████      ▓▓▓▓      ▓▓▓▓██      ▓▓▓▓░░    ▓▓▓▓▓▓)"; color(white); std::cout << R"(   / / __/ / __ \/ ___/ / / /    / / / __ \   )"; color(blue); std::cout << R"(/ / / / //_/ ___/ __  / / __ \/ _ \)" << '\n'; color(8);
        //std::cout << R"(    ▓▓▓▓▓▓      ▓▓▓▓▓▓    ▓▓▓▓▓▓    ▒▒▓▓▓▓      ▒▒▓▓▓▓)"; color(white); std::cout << R"(  / /_/ / / /_/ / /  / /_/ /    / / / /_/ /  )"; color(yellow); std::cout << R"(/ /_/ / ,< / /  / /_/ / / / / /  __/)" << '\n'; color(8);
        //std::cout << R"(    ▓▓▓▓▓▓    ▓▓▓▓▒▒▓▓    ▓▓▓▓▓▓    ▓▓▓▓▓▓██    ██▓▓▓▓)"; color(white); std::cout << R"(  \____/_/\____/_/   \__, /    /_/  \____/   )"; color(yellow); std::cout << R"(\____/_/|_/_/   \__,_/_/_/ /_/\___/)" << '\n'; color(8);
        //std::cout << R"(    ▓▓▓▓▓▓  ██▓▓▓▓▓▓▓▓  ██▒▒▓▓████  ▓▓▓▓▓▓▓▓▓▓  ▓▓▓▓▓▓)"; color(white); std::cout << R"(                    /____/)" << '\n'; color(8);
        //std::cout << R"(    ▓▓▓▓▓▓▒▒▓▓▓▓▓▓    ░░▓▓▓▓░░▓▓▓▓    ░░██▒▒▓▓▓▓▒▒▓▓▓▓)" << '\n';
        //std::cout << R"(    ▓▓▓▓▓▓▓▓▓▓██░░    ▓▓▓▓▓▓  ▓▓██▓▓    ░░▓▓▓▓▓▓▓▓▓▓▓▓)" << '\n';
        //std::cout << R"(    ██▓▓▓▓▓▓▓▓▓▓▓▓  ▓▓▓▓▓▓      ▓▓▓▓▓▓  ▓▓▓▓██▓▓▓▓▓▓▓▓)" << '\n';
        //std::cout << R"(    ▒▒████░░████▓▓▓▓▓▓▓▓▓▓      ▓▓▓▓▓▓▓▓██▓▓▓▓░░██▓▓▓▓)"; color(white);  std::cout <<"  Press \"enter\" -> to back to main menu.\n"; color(8);
        //std::cout << R"(    ████▓▓    ▓▓▓▓██▒▒▓▓████  ▓▓██▒▒▓▓▓▓██▓▓░░  ▓▓██▒▒)" << '\n';
        //std::cout << R"(    ▓▓▓▓▓▓    ░░▓▓▓▓▓▓▓▓▓▓▓▓▓▓██▓▓▓▓▓▓▓▓▓▓░░    ▓▓▓▓▓▓)" << '\n';
        //std::cout << R"(    ▓▓▓▓▓▓      ░░▓▓▓▓▓▓░░▓▓██▓▓░░▓▓▓▓▓▓░░      ▓▓▓▓▓▓)" << '\n';
        //std::cout << R"(    ▓▓▓▓▓▓        ▓▓▓▓░░  ▓▓▓▓▓▓  ░░▓▓▓▓        ▓▓▓▓▓▓)" << '\n';
